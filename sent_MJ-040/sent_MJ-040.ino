...
void sendDataToServer() {
    ...
    float temperature =  0.91 * measuredTemp -2.29;
    ...
    //String path = "/BAC_WebApplications/AdrunoTemperature/TemperaturePost?Temp1=MJ-040&CH1=" + String(temperature) + "&CH2=0&DateCreate=" + String(dateBuffer);
    String path = "/BAC_WebApplications/AdrunoTemperature/TemperaturePost?Temp1=Assy&CH1=" + String(temperature) + "&CH2=0&DateCreate=" + String(dateBuffer);
