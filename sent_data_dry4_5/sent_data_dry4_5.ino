...
void sendDataToServer() {
    float temp_dry_4 = ts1.getCelsius()+7.7;
    float temp_dry_5 = ts2.getCelsius()+35.75;
    ...
    // Sending data for dry-4
    path = "/BAC_WebApplications/AdrunoTemperature/TemperaturePost?Temp1=Dry_4&CH1=" + String(temp_dry_4) + "&CH2=0&DateCreate=" + String(dateBuffer);
    sendHttpRequest(path);

    // Sending data for dry-5
    path = "/BAC_WebApplications/AdrunoTemperature/TemperaturePost?Temp1=Dry_5&CH1=" + String(temp_dry_5) + "&CH2=0&DateCreate=" + String(dateBuffer);
    sendHttpRequest(path);
}
